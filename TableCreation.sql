...
use HospitalHub;
create table Hospital(HospID integer primary key, HospName varchar(100), HospBuilding varchar(25), HospStreet varchar(25), HospPinCode int, HospBeds int, HospAvailBed int, HospAmbID int unique);
create table HospPincode(Pincode integer primary key, foreign key(Pincode) references Hospital(HospPinCode), HospCity varchar(25), HospCountry varchar(25));
...
create table Amb(AmbID int primary key, foreign key(AmbID) references Hospital(HospAmbID), AmbVehicleType varchar(25));
...
create table User(UserID int primary key, UserEmailID varchar(25) not null unique, UserPhone varchar(10) unique, UserBDay date, UserGenderID int, UserCity varchar(25), UserBuilding varchar(25), UserStreet varchar(25), UserPinCode int, UserProfilePicAdd varchar(100));
